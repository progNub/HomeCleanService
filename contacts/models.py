...
class ContactRequest(models.Model):
    ...
    phone_validator = RegexValidator(
        regex=r'^\+?1?\d{9,15}$',
        message=_("Номер телефона должен быть в формате: '+999999999'. Допускается до 15 цифр.")
    )
    ...
    email = models.EmailField(blank=True, verbose_name=_("Email"), help_text=_("Ваш контактный email"))
